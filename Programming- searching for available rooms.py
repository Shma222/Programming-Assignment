...
#here we are testing the search for available rooms
def available_rooms(): #define the sreach for available rooms
    room1 = Room(200, "Single", ["Wi-Fi", "TV"], 100.0, False)# the room will be unavailable since it is false
    room2 = Room(202, "Suite", ["Wi-Fi", "Minibar", "TV", "Sauna"], 150.0, True)# the room will be available since it is true
