...
#testing the room reservation 
def test_room_reservation():
    #create two objects for guests
    guest1 = Guest(1, "Ahmed", "Ahmed@gmail.com", 400)
    guest2 = Guest(2, "Fatima", "Fatima@gmail.com", 700)

    #create an object for the room
    room2 = Room(1, "Suite", ["Wi-Fi", "Sauna"], 500.0, True)
    
    #booking for guest1
    booking1 = Booking(211, guest1, room2, "2025-07-10", "2025-07-15")
    booking1.confirm_booking()
    print(f"Reservation successful for {guest1}: {booking1}")

    #booking for guest2
    booking2 = Booking(212, guest2, room2, "2025-07-10", "2025-07-15")
    booking2.confirm_booking()
    print(f"Reservation successful for {guest2}: {booking2}")
