...
#testing the guest account creation 
def guest_test():# here we define the guets test
    guest1 = Guest(200, "Shamma Saif", "Shamma@gmail.com", 450)
    guest2 = Guest(202, "Mariam Ahmed", "Mariam@example.com", 600)
