...
#testing the booking invoice generation
def test_invoice_generation():
    #invoice for first guest
    guest1 = Guest(1, "Ahmed", "Ahmed@gmail.com", 400)
    room1 = Room(1, "Suite", ["Wi-Fi", "Sauna"], 500.0, True)
    booking1 = Booking(211, guest1, room1, "2025-07-10", "2025-07-15")
    payment1 = Payment(301, booking1, "Debit Card", 500.0, 50.0, 20.0)
    print(guest1,"Invoice:",{payment1.generate_invoice()})

    #invoice for second guest
    ...
    payment2 = Payment(302, booking2, "Cash", 1000.0, 100.0, 30.0)
    print(guest2,"Invoice:",{payment2.generate_invoice()})
