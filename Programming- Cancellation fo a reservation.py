...
def cancellation():
    #first guest's cancelled reservation
    guest1 = Guest(1, "Ahmed", "Ahmed@gmail.com", 500)
    room1 = Room(1, "Suite", ["Wi-Fi", "Sauna"], 600.0, True)
    booking1 = Booking(222, guest1, room1, "2025-06-11", "2025-06-17")
    booking1.confirm_booking()
    booking1.cancel_booking()
    print(f"Cancellation was successful for {guest1}: {booking1}")

    #second guest's cancelled reservation
    guest2 = Guest(2, "Fatima", "Fatima@gmail.com", 700)
    room2 = Room(2, "Presidential", ["Wi-Fi", "Private Pool"], 1000.0, True)
    booking2 = Booking(224, guest2, room2, "2025-09-02", "2025-09-06")
    booking2.confirm_booking()
    booking2.cancel_booking()
    print(f"Cancellation was successful for {guest2}: {booking2}")
